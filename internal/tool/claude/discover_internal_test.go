...
func TestAutoDetectPlaceholders(t *testing.T) {
	...
	suggestions := autoDetectPlaceholders(prefixes, "/Users/test/Projects/myproject", "/Users/test")
...
func TestAutoDetectPlaceholders_Empty(t *testing.T) {
	suggestions := autoDetectPlaceholders(nil, "/Users/test/project", "/Users/test")
...
func TestDiscoverPlaceholders_EmitsBothAnchorsLongestFirst(t *testing.T) {
	...
	suggestions := discoverPlaceholders(
		content,
...
func TestDiscoverPlaceholders_DropsBase64FromMCPResponses(t *testing.T) {
	...
	suggestions := discoverPlaceholders(content, "/Users/tap-user/Software/homebrew-tap", "/Users/tap-user")
...
// assertOnlyAnchorPlaceholders fails the test if suggestions contains
// anything beyond the two anchor keys, or if any noiseFragment appears as
// an Original.
